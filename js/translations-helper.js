(function($) {
  ...
  //   $(
  //     ".container h1, .container h2, .container h3, .container h4, .container h5, .container h6, .container p, .container span, .container button.button, #homeSlider-nav a"
